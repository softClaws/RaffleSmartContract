...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    function enterRaffle() public payable {
        ...
        if(s_raffleState != RaffleState.OPEN){ //ensure new player can only join when raffle is open
    ...
    ) internal override { //this function is called in an external function from the inherited contract
